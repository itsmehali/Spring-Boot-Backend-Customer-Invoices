...
public class UserQuery {
    ...
    public static final String DELETE_USER_FROM_PASSWORD_VERIFICATION_QUERY = "DELETE url FROM ResetPasswordVerifications WHERE user_id = :userId";
    ...
    public static final String SELECT_USER_USER_BY_ACCOUNT_URL_QUERY = "SELECT * FROM Users WHERE id = (SELECT user_id FROM AccountVerifications WHERE url = :url)";
