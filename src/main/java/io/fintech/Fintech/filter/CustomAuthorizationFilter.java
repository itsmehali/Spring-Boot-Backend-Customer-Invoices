package io.fintech.Fintech.filter;
...
public class CustomAuthorizationFilter extends OncePerRequestFilter {
    ...
    private static final String[] PUBLIC_ROUTES = {"/user/login", "/user/register", "/user/verify/code", "/user/refresh/token", "/user/image", "/user/new/password"};
    ...
    // Getting the Token and looking for the Bearer and emptying it, and then returning the token.
